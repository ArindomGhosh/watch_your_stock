...
abstract class $UserEntityCopyWith<$Res> {
  ...
  $Res call({String userName, String userEmail, String userToken});
}
...
class _$_UserEntity extends _UserEntity with DiagnosticableTreeMixin {
  const _$_UserEntity(
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserEntity(userName: $userName, userEmail: $userEmail, userToken: $userToken)';
  }
...
abstract class _UserEntity extends UserEntity {
  const factory _UserEntity(
      {required String userName,
      required String userEmail,
      required String userToken}) = _$_UserEntity;
